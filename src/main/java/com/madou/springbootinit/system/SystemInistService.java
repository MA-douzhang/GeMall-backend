package com.madou.springbootinit.system;

import com.madou.springbootinit.service.GemallSystemService;
import com.madou.springbootinit.utils.SystemInfoPrinter;
...
class SystemInistService {
    ...
    private void inist() {
        ...
        initConfigs();
        SystemInfoPrinter.printInfo("Gemall 初始化信息", getSystemInfo());
    }
    ...
    @Resource
    private GemallSystemService litemallSystemConfigService;
